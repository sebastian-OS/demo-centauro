...
(function () {
  ...
  function renderDbPage(pageDef) {
    ...
    page.appendChild(el('div', 'cover' + (meta.cover === 'amber' ? ' amber' : ''), '<div class="glow"></div>'));
    page.appendChild(el('span', 'page-ico', db.icon));

...
window.DEMO = (function () {
  ...
  const seleccion = {
    ...
    rows: [
      ...
      { puesto: 'Rental Agent · Heraklión (Creta)', sede: 'Aeropuerto', pais: 'Grecia', fase: 'Vacante abierta', candidatos: '6', reclutador: 'Talent Acq.', objetivo: '2026-07-20' },
  ...
  const dbMeta = {
    seleccion: {
      ...
      meta: [['Vacantes en pipeline', '12'], ['Países', '4'], ['Fases estándar', '6'], ['Fuente', '16 vacantes LinkedIn']],
    },
    onboarding: {
      cover: 'dark',
      accent: '#E0794A',
